...
//        System.out.println("1. TaskRemainder");
    ...
    public void run() {
        ...
        printIncreasingChunkAndIncreasingNum(num);

        printIncreasingChunkAndDecreasingNum(num);

    }

    private void printIncreasingChunkAndIncreasingNum(int num) {
        while (num <= max) {
            if (remainder == 1) {
    ...
    private void printIncreasingChunkAndDecreasingNum(int num) {
